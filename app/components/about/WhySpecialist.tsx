    ...
    return (
        <section className="w-full py-16 px-4 sm:px-6 lg:px-8 bg-white">
            <div className="max-w-5xl mx-auto">
                ...
                <h2 className="text-2xl sm:text-3xl font-bold text-[#1E2E4B] text-center mb-10">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    {REASONS.map(({ icon: Icon, title, description }, i) => {
                        ...
                        return (
                            ...
                            >
                                <div className="shrink-0 w-10 h-10 rounded-lg bg-[#1E2E4B]/8 flex items-center justify-center mt-0.5">
                                    <Icon size={18} className="text-[#ABBD4F]" strokeWidth={1.5} />
                                </div>
                                <div>
                                    <p className="text-sm md:text-base font-semibold text-[#1E2E4B] mb-0.5">
                                        {title}
                                    </p>
