        ...
        subServices: [
            {
                ...
                subtitle: "Accurate filings. Risk-controlled compliance.",
                description: [
            ...
            },
            {
                ...
                subtitle: "Mitigate risks. Ensure global compliance. Protect value.",
                description: [
    ...
    return (
        <div className="border border-gray-200 rounded-lg overflow-hidden mb-2.5">
            ...
            <button
                ...
                className={`w-full flex items-center gap-3.5 px-4 py-4 text-left bg-white transition-colors ${
                    isOpen ? "bg-[#bac48c] " : ""
                } ${isExpandable ? "cursor-pointer hover:bg-gray-50" : "cursor-default"}`}
            ...
            >
                ...
                {isExpandable && (
                    <ChevronDown
                        className={`w-4 h-4 text-[#ABBD4F] flex-shrink-0 transition-transform duration-200 ${
                            isOpen ? "rotate-180" : ""
                        }`}
                    />
                )}
                        ...
                        {service.features && (
                            <div className="grid grid-cols-2 md:grid-cols-4 gap-4 px-4 pb-4">
                                {service.features.map((feature, i) => (
                                    <div
                                        key={i}
                                        className="w-40 h-40 rounded-full flex flex-col items-center justify-center bg-[#C1DC3A] px-6"
                                    >
                                        <p className="text-lg font-bold text-[#283F67] text-center">
                                            {feature.title}
                                        </p>
                                        <p className="leading-relaxed text-center text-[#283F67] text-xs">
                                            {feature.description}
                                        </p>
                                    </div>
                                ))}
