...
export default function HeroSection() {
    return (
        <section className="relative w-full overflow-hidden bg-[#F6FAFF] min-h-[480px] lg:min-h-[640px] mt-20">
            ...
            <div className="relative max-w-[1200px] mx-auto px-4 sm:px-6 lg:px-8 h-full flex flex-col lg:flex-row items-end min-h-[480px] lg:min-h-[560px]">
                ...
                {/* ── Left: Text card ── */}
                <div className="relative z-10 w-full lg:w-[52%] flex items-end justify-end py-12 lg:py-0">
                    <div
                        className="relative bg-[#ABBD4F] rounded-[40px] px-7 py-10 sm:px-10 sm:py-12 lg:px-12 lg:py-14 max-w-[520px] w-full shadow-lg border-y-12 border-y-[#283F67]"
                    >

                        {/* Headline */}
                        <h1 className="text-white font-bold text-[26px] sm:text-[30px] lg:text-[34px] leading-tight tracking-tight mb-4">
                        ...
                        {/* Sub-headline */}
                        <p className="text-white/90 text-[13.5px] sm:text-[14px] leading-relaxed mb-8 max-w-[340px]">
